...
\section*{Question 1}{
    ...
    \subsubsection*{e.}}{
        As \textit{b.} mentioned, \(\mathit{B_3}=\mathrm{\{1,2,3,6\}},\mathit{B_4}=\mathrm{\{4,5\}}\). If we use \textit{Best-in Greedy}, we may lose the \(\mathit{B_4}\), because there is a solution when the first choice is 6. 
    }
}
